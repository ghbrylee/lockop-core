...
int main(void){
    ...
    std::string privKeyRaw = address.generatePrivKey();
    std::string publicKey = address.getAddress(privKeyRaw);

    std::cout << "[TEST] privkey : " << privKeyRaw << std::endl;
    std::cout << "[TEST] publickey : " << publicKey << std::endl;
